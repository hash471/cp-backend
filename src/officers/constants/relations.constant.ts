...
export const LEAF_STATION_MAP: Record<string, string> = {
  ...
  'DSI_IITOWN':        'II Town',
  'DSI_MR-PETA':       'Maharanipeta',
  'DSI_IIITOWN':       'III Town',
  'DSI_IVTOWN':        'IV Town',
  'DSI_DWARAKA':       'Dwaraka Nagar',
  'DSI_MVP':           'Muvvalavanipalem',
  'DSI_ARILOVA':       'Arilova',
  'DSI_PMPALEM':       'PM Palem',
  'DSI_BHEEMILI':      'Bhimunipatnam',
